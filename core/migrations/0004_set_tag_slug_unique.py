...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.SlugField(db_index=True, unique=True, max_length=50, blank=True))
        db.alter_column('core_tag', 'slug', orm['core.tag:slug'])
        
        # Creating unique_together for [slug] on Tag.
        db.create_unique('core_tag', ['slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [slug] on Tag.
        db.delete_unique('core_tag', ['slug'])
        
        # Changing field 'Tag.slug'
        # (to signature: django.db.models.fields.SlugField(blank=True, max_length=50, null=True, db_index=True))
        db.alter_column('core_tag', 'slug', orm['core.tag:slug'])
